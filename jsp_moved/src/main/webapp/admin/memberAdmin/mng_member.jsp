                                        ...
                                        <thead>
                                         ...
                                         <tbody>
                    								...
                    								if (curPage == null){
                    									...
                    									MemberDao bbsdao = new MemberDao();
												        ArrayList<MemberVo> result = bbsdao.getBoardListAll(curPage);
												        //out.println(result.size());
												        for (int i=0; i<result.size(); i++){
												        	MemberVo eachvo = result.get(i);
											         %>

                                            <tr>
                                                <th scope="row"><%= eachvo.getId() %></th>
                                                <td><a href="../boardAdmin/mng_bbsread.jsp?no=<%=eachvo.getId()%>"><%= eachvo.getName() %></td>
                                                <td><%= eachvo.getEmail() %></td>
                                                <td><%= eachvo.getPhone() %></td>
                                            </tr>
											<%
												        }
											%>
