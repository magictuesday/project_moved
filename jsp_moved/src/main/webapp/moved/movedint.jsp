        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">[MOVED Project]의 목표는 머신러닝을 통한 이사 비용에 대한 견적을 구현하는 것이 목표 입니다.
고객은 업체의 견적 산출에 대해 의구심을 가지고 있고, 대다수의 영세한 업체들은 광고나 마케팅에 대한 비용 부담이 크다. </p>
